...
interface ColorPickerInputProps extends Omit<ComponentProps<typeof Input>, "value" | "onChange" | "color"> {
...
interface InputGroupItemProps extends ComponentProps<typeof Input>, VariantProps<typeof inputGroupItemVariants> {}
