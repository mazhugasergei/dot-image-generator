...
const [MotionGridProvider, useMotionGrid] = getStrictContext<MotionGridContextType>("MotionGridContext")
...
function MotionGridCells({ activeProps, inactiveProps, ...props }: MotionGridCellsProps) {
	...
	return Array.from({ length: cols * rows }).map((_, i) => {
		...
		componentProps.className = cn(props?.className, isActive ? activeProps?.className : inactiveProps?.className)
